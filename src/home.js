    ...
    <div style={{ display: show }}>
      ...
      <div className="rooms">
        <div
          className="room"
          onClick={() => {
            currentRoom[0] = 1 + (currentLevel - 1) * 5;
            page[0] = "to-room";
          }}
        >
          1
        ...
        <div
          className="room"
          onClick={() => {
            currentRoom[0] = 2 + (currentLevel - 1) * 5;
            page[0] = "to-room";
          }}
        >
          2
        ...
        <div
          className="room"
          onClick={() => {
            currentRoom[0] = 3 + (currentLevel - 1) * 5;
            page[0] = "to-room";
          }}
        >
          3
        ...
        <div
          className="room"
          onClick={() => {
            currentRoom[0] = 4 + (currentLevel - 1) * 5;
            page[0] = "to-room";
          }}
        >
          4
        ...
        <div
          className="room"
          onClick={() => {
            currentRoom[0] = 5 + (currentLevel - 1) * 5;
            page[0] = "to-room";
          }}
        >
          5
